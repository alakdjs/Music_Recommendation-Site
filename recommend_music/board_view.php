...
?>		
	    ...
	    <ul class="buttons">
                ...
                <li>
                    ...
                    if($total_like >= 10) // 만약 추천이 10개가 넘으면
                    {
                ...
                <li>
                    ...
                    {
                    ?>
                    <form name="loved_form" method="post" action="love_delete.php" style="display:inline;">
                    ...
                    {
                    ?>
                    <form name="love_form" method="post" action="love.php" style="display:inline;">
                    <input type="hidden" name="bo_num" value="<?=$num?>">
                    <input type="hidden" name="page" value="<?=$page?>">
        ...
        <?php include_once "reply_form.php"; ?>
	</div> <!-- board_box -->
</section> 
<footer>
