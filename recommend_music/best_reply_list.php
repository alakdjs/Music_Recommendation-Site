...
<?php
	...
	{
		$new_page = $re_page-1;
		echo "<li><a href='best_view.php?num=$num&page=$page&re_page=$new_page'>◀ 이전</a> </li>";
	}		
	else 
		echo "<li>&nbsp;</li>";
   	...
   	for ($i=1; $i<=$total_page; $i++)
   	{
		...
		{
			echo "<li><a href='best_view.php?num=$num&page=$page&re_page=$i'> $i </a> <li>";
		}
   	}
   	if ($total_page>=2 && $re_page != $total_page)		
   	{
		$new_page = $re_page+1;	
		echo "<li> <a href='best_view.php?num=$num&page=$page&re_page=$new_page'>다음 ▶</a> </li>";
	}
	else 
		echo "<li>&nbsp;</li>";
?>
